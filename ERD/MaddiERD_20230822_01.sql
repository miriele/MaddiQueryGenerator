...
DROP TABLE IF EXISTS md_bh;
DROP TABLE IF EXISTS md_srch;
...
DROP TABLE IF EXISTS md_recommend;
...
CREATE TABLE md_bh
(
	bh_id smallint NOT NULL AUTO_INCREMENT COMMENT 'ID',
	bjd_code numeric(10) NOT NULL COMMENT '법정동코드',
	hjd_code numeric(10) NOT NULL COMMENT '행정동코드',
	PRIMARY KEY (bh_id)
) COMMENT = '법정동행정동';
...
-- 클릭통계
CREATE TABLE md_click
(
	click_id int NOT NULL AUTO_INCREMENT COMMENT '클릭ID',
	stor_m_id int NOT NULL COMMENT '매장메뉴ID',
	user_id varchar(20) COMMENT '회원ID',
	click_ts timestamp NOT NULL COMMENT '클릭시각',
...
(
	hjd_code numeric(10) NOT NULL COMMENT '행정동코드',
	hjd_name varchar(80) NOT NULL COMMENT '행정동명',
	hjd_x smallint NOT NULL COMMENT '격자X',
	hjd_y smallint NOT NULL COMMENT '격자Y',
	PRIMARY KEY (hjd_code)
) COMMENT = '행정동코드';
...
-- 추천메뉴
CREATE TABLE md_recommend
(
	reco_id int NOT NULL AUTO_INCREMENT COMMENT '추천메뉴ID',
	user_id varchar(20) NOT NULL COMMENT '회원ID',
	menu_id int NOT NULL COMMENT '메뉴ID',
	PRIMARY KEY (reco_id)
) COMMENT = '추천메뉴';
...
-- 검색통계
CREATE TABLE md_srch
(
	srch_id int NOT NULL AUTO_INCREMENT COMMENT '검색ID',
	user_id varchar(20) COMMENT '회원ID',
	bjd_code numeric(10) NOT NULL COMMENT '법정동코드',
	srch_word varchar(60) NOT NULL COMMENT '검색어',
	srch_ts timestamp NOT NULL COMMENT '검색시각',
	PRIMARY KEY (srch_id)
) COMMENT = '검색통계';
...
ALTER TABLE md_bh
	ADD FOREIGN KEY (hjd_code)
	REFERENCES md_hjd (hjd_code)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
